      ...
      <div className="space-y-2">
        <div className="flex">
          <input
            ...
            disabled={disabled}
            className="flex-grow rounded-l-md p-2 border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-400 focus:outline-none transition-all duration-200 dark:bg-gray-700 dark:text-white"
          />
          <button
  ...
  const TestDetailModal = () => (
    <div className="fixed inset-0 bg-black bg-opacity-50 dark:bg-opacity-70 flex justify-center items-center z-50 backdrop-blur-sm animate-fadeIn">
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-4/5 max-w-4xl shadow-2xl border border-gray-200 dark:border-gray-700 transform transition-transform duration-300 max-h-[90vh] overflow-y-auto">
        ...
        {error && (
          <div className="bg-red-100 border border-red-400 text-red-700 dark:bg-red-900/30 dark:border-red-800 dark:text-red-300 px-4 py-3 rounded relative mb-4 flex items-center">
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input 
                ...
                className="w-full rounded-md p-2 border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-400 focus:outline-none transition-all duration-200 dark:bg-gray-700 dark:text-white font-mono"
            ...
            <div>
              ...
              <input 
                ...
                className="w-full rounded-md p-2 border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-400 focus:outline-none transition-all duration-200 dark:bg-gray-700 dark:text-white"
          ...
          <div>
            ...
            <textarea 
              ...
              className="w-full resize-none rounded-md p-2 border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-400 focus:outline-none transition-all duration-200 dark:bg-gray-700 dark:text-white"
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-6">
        <h1 className="text-3xl font-bold mb-4 md:mb-0 bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-500 dark:to-indigo-500 bg-clip-text text-transparent">
          Test Specifications
        </h1>
          ...
          <>
            <div className="overflow-x-auto">
              <table className="w-full table-auto border-collapse">
                <thead className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/40 dark:to-indigo-900/40 text-gray-700 dark:text-gray-200">
                  <tr>
                    ...
                    <th className="border border-gray-200 dark:border-gray-700 p-2 text-left w-24">
                      <div className="flex items-center">
                        ID
                        <FaSort className="ml-1 text-gray-400 hover:text-blue-500 dark:hover:text-blue-400" />
                      </div>
                    </th>
